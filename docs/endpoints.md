...
**Body de `PATCH /api/users/:id`:** _(todos los campos son opcionales)_
...
```json
{
  "customerName": "Jose Pérez", // Opcional
  "items": [
    {
      "productId": "uuid",
      "quantity": 2,
      ...
      "payments": { "usdTarjeta": 10, "usdFisico": 0, "cop": 0, "ves": 0 }
    }
  ],
  "receivedTotals": { "usdFisico": 0, "usdTarjeta": 10, "cop": 0, "ves": 0 },
  "status": "pagado"
}
```
...
```json
{
  "data": [
    {
      "id": "uuid",
      "customerName": "Jose Pérez", // Nullable
